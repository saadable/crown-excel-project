...
import LaptopImage1 from '../../../../../Components/Images/scannerbanner1.png'
import LaptopImage2 from '../../../../../Components/Images/scannerbanner2.png'
import Image from 'next/image'
import Stars from '../../../../../Components/Images/stars.png'
const ScannerCopierBanner = () => {
  return (
    <div >
      <div
      ...
      >
        ...
        <div className="laptop-banner-center z-10 absolute left-50 right-50 flex-1 flex flex-col items-center justify-center text-center px-2 md:px-8">
          ...
          <p className="text-gray-200 text-sm md:text-lg font-medium max-w-xl mx-auto mb-2 md:mb-4 w-[510px]">
            Crown Excel has the newest models of scanners from top brands. We have specifically what you need: business-grade performance, sleek designs for everyone, or high-powered machines for professional tasks.
          </p>
        </div>
        {/* Right Laptop Image */}
        ...
        <div className="top mt-20">
          <div className="laptop-banner-center ">
            ...
            <div className="text relative flex flex-col items-center mb-4 leading-tight">
              ...
              <h1 className='text-[30px] font-montserrat font-[900] text-[#147d61]'>SCANNERS BRANDS</h1>
            ...
            <p className="text-gray-200 text-[14px] text-center font-light">
              Crown Excel has the newest models of scanners from top brands. <br className='hidden md:block'/> We have specifically what you need: business-grade performance, <br className='hidden md:block'/> sleek designs for everyone, or high-powered machines for professional tasks.
            </p>
          </div>
        </div>
...
export default ScannerCopierBanner
