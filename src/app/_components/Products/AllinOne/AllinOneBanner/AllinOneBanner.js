...
import DesktopImage1 from '../../../../../Components/Images/screenallinonebanner.png'
       ...
       <div className="small-screen flex flex-col gap-20 py-20 items-center justify-center md:hidden lg:hidden h-auto w-full" style={{
         ...
         <div className="top">
           <div className="laptop-banner-center ">
             ...
             <div className="text relative text-center flex flex-col items-center mb-4 leading-tight">
