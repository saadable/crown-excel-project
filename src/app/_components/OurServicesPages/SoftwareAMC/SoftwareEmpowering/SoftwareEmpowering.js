...
import NetworkIT from '../../../../../Components/Images/softwareemopwering.png';

const SoftwareEmpowering = () => {
  return (
      ...
      <div className="flex flex-col md:flex-row lg:flex-row md:items-start lg:items-center lg:justify-between md:gap-5 lg:gap-10">
        ...
        <div className="relative w-full items-start px-5 md:px-2 lg:px-0 lg:w-1/2 z-10 flex flex-col gap-6 mt-5 md:mt-5 lg:mt-[-40px]">
          ...
          <p className="text-black text-base md:text-[16px] leading-[27.2px] font-montserrat z-30">
            Crown Excel’s Software AMC services ensure that your business-critical applications operate without interruptions. From regular updates to performance enhancements, we provide end-to-end maintenance services that prevent downtime, eliminate bugs, and optimize efficiency. Let us handle your software while you focus on scaling your business.
          </p>
      ...
      <div className="mt-5 lg:mt-20 px-4 flex flex-col md:flex-row lg:flex-row items-center justify-between gap-5">
              ...
              <div className="empowering-right gap-5 md:gap-5 lg:gap-5 relative basis-[50%] flex flex-col items-start mt-5 md:mt-10 lg:-mt-10 z-10 px-2 lg:px-0">
                ...
                <h1 className="text-[32px] md:text-[43px] lg:text-[52px] text-black font-[600] leading-[40px] lg:leading-[52px] font-montserrate">
                 Expert Software Care for Maximum Reliability
                </h1>
                <p className="text-[16px] text-black leading-[27.2px] font-montserrat">
                  Your software is the backbone of your business operations, and it deserves expert attention. Our team of skilled professionals ensures your applications are secure, reliable, and always compliant with the latest standards. With Crown Excel’s AMC, your software systems are always ready to meet your business challenges.
                </p>
...
export default SoftwareEmpowering;
